...
template 
void Gemv(const CBLAS_TRANSPOSE TransA, int M, int N, float alpha, const float* A, const float* x,
                              float beta, float* y, CPUMathUtil* );
template 
void Gemv(const CBLAS_TRANSPOSE TransA, int M, int N, float alpha, const double* A, const double* x,
